...
// Actions
import * as actions from "../../../redux/actions/memberCategoryActions";
              ...
              <div className="col-md-12">
                <div className="datatable-header-tools">
                  <div className="datatable-actions">
                    ...
                    >
                      <i className="fa fa-plus"></i> Ангилал нэмэх
                    </button>
                    <button
                      className={`datatable-action add-bg ${
                    ...
                    >
                      <i className="fa fa-plus"></i> Дэд ангилал нэмэх
                    </button>
                    <button
                ...
                <div className={`card card-custom`}>
                  <div className="card-body">
                    <h3 className="card-title">
                      СОНГОГДСОН АНГИЛАЛ: {selectData && selectData.name}
                    </h3>
                  </div>
                </div>
              </div>
...
const mapStateToProps = (state) => {
  return {
    success: state.memberCategoryReducer.success,
    error: state.memberCategoryReducer.error,
    loading: state.memberCategoryReducer.loading,
    categories: state.memberCategoryReducer.menus,
    category: state.memberCategoryReducer.menu,
  };
};
